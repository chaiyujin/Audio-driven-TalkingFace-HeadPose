...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str, default="../model/atcnet/atcnet_lstm_24.pth")
    parser.add_argument("--sample_dir", type=str, default="../results/atcnet/test/")
...
def test():
    config = parse_args()
    done_flag = os.path.join(config.sample_dir, "done.flag")
