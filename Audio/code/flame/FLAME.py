...
class FLAME(nn.Module):
    ...
    def __init__(self, model_path="~/assets/3DMM-FLAME/assets/FLAME2020/generic_model.pkl", n_shape=100, n_exp=50):
    ...
    def forward(self, code_dict: Dict[str, Optional[Tensor]], v_template: Optional[Tensor] = None):
        ...
        shape     = self._check_params(shape,     N, self.n_shape)
        exp       = self._check_params(exp,       N, self.n_exp)
